...
bool get_file_lists(string input, string ext, string tag, vector<string> &dat_files, vector<string> &log_files, vector<string> &disp_files, vector<string> &edat_files){
